...
<?php
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT booking_id, user_id, room_id, check_in, check_out, trans_amt, trans_status, booking_status FROM bookings");
        $stmt->execute();
        ...
        while ($booking = $result->fetch_assoc()) {
            ...
            $bookingRows .= "
                <tr>
                    ...
                    <td>
                        <button type='button' onclick='download($booking[booking_id])' class='mt-2 btn btn-outline-danger shadow-none btn-sm fw-bold'>
...
?>
  ...
  <div class="col-lg-9 ms-auto p-4 overflow-scroll">
    <h3 class="mb4">Booking Records</h3>
